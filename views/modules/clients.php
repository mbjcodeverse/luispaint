...
<div class="row align-items-center h-100" style="margin:0;margin-top: 13px;">
  ...
  <form role="form" id="form-customer" method="POST" autocomplete="nope">
    <div class="card" style="border:1px solid rgba(255, 255, 255, 0.1);box-shadow: 10px 10px 30px rgba(0, 0, 0, 0.7); border-radius: 10px;">
      <div class="card-header d-flex bg-transparent border-bottom" style="border:1px solid rgba(255, 255, 255, 0.3);box-shadow: 2px 2px 10px rgba(0, 0, 0, 0.5); border-radius: 10px;">
        <h5 class="card-title flex-grow-1 profile-header-title">CUSTOMER INFORMATION</h5> 
      ...
      <div class="card-body">
        <div class="row">
            ...
            <div class="col-sm-2 form-group">
                <label for="txt-customercode">Cust Code</label>
                <input type="text" class="form-control profile-code" id="txt-customercode" name="txt-customercode" autocomplete="nope" required readonly="true">
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-2 form-group">
                <label for="num-creditlimit">Credit Limit</label>
                <input type="text" class="form-control numeric hide-cursor" id="num-creditlimit" name="num-creditlimit" value="0.00" autocomplete="nope">
            </div>            
    ...
    <?php
      $createCustomer = new ControllerClients();
      $createCustomer -> ctrCreateCustomer();

      $editCustomer = new ControllerClients();
